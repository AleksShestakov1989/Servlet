...
//        resp.setHeader("MyCustomHeader","MyCustomHeaderValue");
//        resp.getWriter().print("Hello from main servlet");
//    }
    @Override
    public void init() {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            if (method.equals(GET) && path.matches(API_POSTS_ID)) {
                // easy way
                controller.getById(idGetPost(path), resp);
                return;
            }
            ...
            if (method.equals(DELETE) && path.matches(API_POSTS_ID)) {
                // easy way
                controller.removeById(idGetPost(path), resp);
                return;
            }
    ...
    private long idGetPost(String path) {
